...
static const sConsoleCommandTable_T mConsoleCommandTable[] =
{
	...
	{"led_delay", &ConsoleCommandLedDelay, HELP("Toggle LED delay: int msec")},
	{"led_sel", &ConsoleCommandLedSelect, HELP("Select led: 0 == red; 1 == green")},
	{"led_set", &ConsoleCommandLedSet, HELP("Set led: 0 == off; 1 == on")},
